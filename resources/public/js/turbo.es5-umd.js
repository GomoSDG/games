    ...
    ***************************************************************************** */
    ...
    var FetchRequest = (function () {
        function FetchRequest(delegate, method, location, body) {
            ...
            if (this.isIdempotent) {
                this.url = mergeFormDataEntries(location, __spreadArray([], __read(body.entries())));
            }
            else {
                this.body = body;
                this.url = location;
            ...
            get: function () {
                return this.templateChildren.reduce(function (streamElements, child) {
                    if (child.tagName.toLowerCase() == "turbo-stream") {
                        return __spreadArray(__spreadArray([], __read(streamElements)), [child]);
                    }
                    else {
    ...
    var FormSubmission = (function () {
        ...
        Object.defineProperty(FormSubmission.prototype, "stringFormData", {
            get: function () {
                return __spreadArray([], __read(this.formData)).reduce(function (entries, _a) {
    ...
    var Snapshot = (function () {
        ...
        Object.defineProperty(Snapshot.prototype, "children", {
            get: function () {
                return __spreadArray([], __read(this.element.children));
            },
            enumerable: false,
            configurable: true
        });
        ...
        Object.defineProperty(Snapshot.prototype, "permanentElements", {
            get: function () {
                return __spreadArray([], __read(this.element.querySelectorAll("[id][data-turbo-permanent]")));
            },
            enumerable: false,
            configurable: true
        });
    ...
    var Bardo = (function () {
        ...
        Object.defineProperty(Bardo.prototype, "placeholders", {
            get: function () {
                return __spreadArray([], __read(document.querySelectorAll("meta[name=turbo-permanent-placeholder][content]")));
            },
            enumerable: false,
            configurable: true
        });
    ...
    function copyElementAttributes(destinationElement, sourceElement) {
        var e_1, _a;
        try {
            for (var _b = __values(__spreadArray([], __read(sourceElement.attributes))), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    var HeadSnapshot = (function (_super) {
        ...
        function HeadSnapshot() {
            ...
            _this.detailsByOuterHTML = _this.children.reduce(function (result, element) {
                ...
                return __assign(__assign({}, result), (_a = {}, _a[outerHTML] = __assign(__assign({}, details), { elements: __spreadArray(__spreadArray([], __read(details.elements)), [element]) }), _a));
            }, {});
            return _this;
        }
            ...
            get: function () {
                ...
                return Object.keys(this.detailsByOuterHTML).reduce(function (result, outerHTML) {
                    ...
                    if (type == null && !tracked) {
                        return __spreadArray(__spreadArray([], __read(result)), __read(elements));
                    }
                    else if (elements.length > 1) {
                        return __spreadArray(__spreadArray([], __read(result)), __read(elements.slice(1)));
                    }
                    else {
                        return result;
                    }
    ...
    var ErrorRenderer = (function (_super) {
        ...
        Object.defineProperty(ErrorRenderer.prototype, "scriptElements", {
            get: function () {
                return __spreadArray([], __read(document.documentElement.querySelectorAll("script")));
            },
            enumerable: false,
            configurable: true
        });
    ...
    var PageRenderer = (function (_super) {
        ...
        Object.defineProperty(PageRenderer.prototype, "newBodyScriptElements", {
            get: function () {
                return __spreadArray([], __read(this.newElement.querySelectorAll("script")));
            },
            enumerable: false,
            configurable: true
        });
